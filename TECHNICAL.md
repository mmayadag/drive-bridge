...
| Connection            | —             | —                             | On the Google account page once connected: the status icon and **Test connection**, which checks Drive with this device's sign-in and says how it went.                                                                                                                                                                       |
| Set up another device | —             | —                             | On the Google account page once connected, with the client on this device: **Export settings**, to import with _Set up from another device_.                                                                                                                                                                                  |
